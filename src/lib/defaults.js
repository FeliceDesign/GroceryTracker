...
// `cooled` markiert gekühlte Lagerorte (für Lager-Hinweise bei geöffneten
// Artikeln). Standard: Kühlschrank/Gefrierschrank = ja, Vorrat/Snacks = nein.
export const DEFAULT_ZONES = [
  { id: 'K', label: 'Kühlschrank', emoji: '🧊', color: '#4A8B6F', cooled: true },
  { id: 'F', label: 'Gefrierschrank', emoji: '❄️', color: '#3B7A9E', cooled: true },
  { id: 'V', label: 'Vorrat', emoji: '🥫', color: '#9C7A3C', cooled: false },
  { id: 'S', label: 'Snacks', emoji: '🍫', color: '#7A6BA8', cooled: false },
];

...
// Phase 2: 6 weitere Artikel (Fisch, Milch/Sahne, Kräuter, Teig).
//
...
export const FROZEN_SHELF_RULES = [
  ...
  { keys: ['lachs', 'hering', 'makrele', 'thunfisch', 'thun'], label: 'Fettreicher Fisch (roh)', months: 3, prep: null, reason: 'Ungesättigte Fettsäuren oxidieren bei Minustemperaturen schneller als bei magerem Fisch – dadurch ranziger Geschmack nach längerer Lagerung.' },
  { keys: ['kabeljau', 'seelachs', 'scholle', 'zander', 'forelle', 'pangasius', 'fisch'], label: 'Fettarmer Fisch (roh)', months: 6, prep: null, reason: 'Fettarme Sorten oxidieren langsamer und bleiben länger geschmacklich stabil als fettreiche Fischarten. Nach dem Auftauen nicht erneut einfrieren.' },
  ...
  { keys: ['sahne', 'obers'], label: 'Sahne', months: 3, prep: 'Luftdicht verpacken, Kontakt mit anderen Lebensmitteln vermeiden; am besten über Nacht im Kühlschrank auftauen.', reason: 'Gilt sowohl für flüssige als auch für bereits geschlagene Sahne.' },
  { keys: ['frischmilch', 'vollmilch', 'h-milch', 'milch'], label: 'Milch', months: 3, prep: 'Nach dem Auftauen gut schütteln/verrühren.', reason: 'Fett und Wasser trennen sich beim Einfrieren – Konsistenz leidet, daher nur zum Kochen verwenden, nicht pur trinken.' },
